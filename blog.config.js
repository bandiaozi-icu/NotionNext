...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'YIYI', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bandiaozi.icu', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'YIYI,博客', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '豫ICP备2023017778号-1', // 备案号 闽ICP备XXXXXXX
