...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '半吊子', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'icu', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bandiaozi.icu', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '半吊子, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2502326702@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link', // 分享的服務，按顺序显示,逗号隔开
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '7c6dd5c0508bda00faa111171ab595b9', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '我是半吊子', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || 'hello, bandiaozi!', // 站点描述，被notion中的页面描述覆盖
